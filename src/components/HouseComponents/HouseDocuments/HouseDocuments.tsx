                        ...
                        <ul className='d-flex'>
                            {
                                docs.map<{ file_name: string, uri: string }>(({ file_name, uri }, index) => (
                                    <li className='d-flex align-items-center gap-xl-10'>
                                        ...
                                        <div className={styles.house__documents__download__icon + ' d-flex justify-content-center align-items-center'}>
                    ...
                    <div className={styles.house__documents__download + ' d-flex'}>
                        <div className='d-flex justify-content-center align-items-center'>
                            ...
                            <div className={styles.house__documents__download__info}>
                                ...
                                <a className='text-center' href={selectedDocument.uri} download={selectedDocument.file_name}>Download</a>
                                </div>
                            </div>
                        </div>
                    </div>
